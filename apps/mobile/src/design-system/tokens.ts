...
export const typography = {
  display: { fontSize: 30, lineHeight: 36, letterSpacing: -0.6, fontWeight: '700' as const },
  title: { fontSize: 22, lineHeight: 28, letterSpacing: -0.35, fontWeight: '700' as const },
  subtitle: { fontSize: 17, lineHeight: 23, letterSpacing: -0.1, fontWeight: '600' as const },
